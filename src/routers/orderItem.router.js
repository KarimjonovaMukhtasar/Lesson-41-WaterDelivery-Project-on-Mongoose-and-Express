...
router.put('/:id', authGuard, roleGuard(['manager', 'admin', 'customer']), validate(orderItemUpdate), OrderItemController.updateOne);
router.delete('/:id', authGuard, roleGuard(['manager', 'admin', 'customer']), OrderItemController.deleteOne);
